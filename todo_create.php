...
//SQL文をCreate
$sql = 'INSERT INTO SC_Questionnaire(id, city, q1, q2, q3, q4, q5, q6, q7, q8, likes, hate, is_deleted, created_at, updated_at) VALUES(NULL, :city, :q1, :q2, :q3, :q4, :q5, :q6, :q7, :q8, :likes, :hate, sysdate(), sysdate())';
